...
Scene = (function (Events, Deferrable) {
    ...
    $.extend(true, Scene.prototype, Events, Deferrable, {
        ...
        /** Handle the navigate event from sideMenu
         *
         */
        navFromSideMenu: function () {
         ...
         */
        navigate: function (direction, snippet) {
        ...
        getCircleFocusable: function (direction, parent) {
            ...
            if (focusedIndex != -1) {
                ...
                /*	if(direction == -1)
                 {
                 els.eq(focusedIndex).slickNext()
                 }else if (direction == 1)
                 {
                 els.eq(focusedIndex).slickPrev()
                 }*/
